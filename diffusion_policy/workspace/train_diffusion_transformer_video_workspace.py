...
class TrainDiffusionTransformerVideoWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: DiffusionTransformerHybridVideoPolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: DiffusionTransformerHybridVideoPolicy = None
            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                if (self.epoch % cfg.training.sample_every) == 0:
                    with torch.no_grad():
                        ...
                        obs_dict = batch["obs"]
                        obs_dict["embedding"] = obs_dict["embedding"]
...
def main(cfg):
    workspace = TrainDiffusionTransformerVideoWorkspace(cfg)
    workspace.run()
